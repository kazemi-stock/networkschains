            ...
            <div class="uk-flex-middle uk-grid" data-uk-grid="">
                <div class="uk-width-2-5@m uk-first-column" style="padding-top: 30px!important;">
                    ...
                    <div class="uk-container uk-flex" id="padd">
                        <a href="{{route('page_show',['slug'=>'readme'])}}"
                           class="sc-button sc-button-large sc-button-danger">Read More</a>
                        <a href=#" uk-toggle="target: #contact"
                           class="active sc-button sc-button-outline sc-button-large uk-margin-left">Contact Us</a>
                    </div>
                </div>
                <div class="uk-width-3-5@m uk-flex uk-flex-right">
                    <img src="{{asset_url('img/undraw_connected_world_wuay.svg')}}" id="display"
                         class="top-section-main-img" alt="">
                </div>
            </div>
        </div>
    </div>
    ...
    <section class="bg padding" id="sect-technologies">
        <div class="uk-container">
            <div class="uk-text-center">
                ...
                <p class="uk-margin-remove">Cyber security and data protection is our priority and that of all companies
                    that use our platform.</p>
            </div>
            <div class="sc-logos">
                ...
                <a href="https://www.vechain.org/" target="_blank"><img src="{{asset_url('img/laravel.png')}}"
                                                                        alt=""></a>
                <a href="https://www.pamtree.com/" target="_blank"><img src="{{asset_url('img/webpack.png')}}"
                                                                        alt=""></a>
    ...
    <section class="bg">
        <div class="uk-container">
            ...
            <div class="uk-child-width-expand@s uk-text-center" uk-grid>
                <div>
                    <img src="{{asset_url('img/peace/image01.jpg')}}" style="height: 230px; width: 500px" class="uk-card uk-card-default uk-card-body" alt="">
                </div>
                <div>
                    <img src="{{asset_url('img/peace/image02.jpg')}}" style="height: 230px; width: 500px" class="uk-card uk-card-default uk-card-body" alt="">
                </div>
                <div>
                    <img src="{{asset_url('img/peace/image03.jpg')}}" style="height: 230px; width: 500px" class="uk-card uk-card-default uk-card-body" alt="">
                </div>
            </div>
            <div class="uk-text-center">
                <h3 class="uk-padding-medium">Cultural and artistic call</h3>
                <h4>Produce a work of art with the theme of peace
                    Supported</h4>
                <h5>Music, Song, the movie, Digital Art, Picture</h5>
                <p>Invitation to participate in a global event
                    Networkschains group, in collaboration with environmental associations based on the principles of sustainability, intends to support and invest in business ideas and projects whose main purpose is to preserve and care for ecosystems.
                    It is preferable that the commercial projects and proposals submitted are based on a smart contract so that they can be submitted in the form of a partnership contract.
                    The topics of the projects, as mentioned, should be in the field of environment, ecosystems, care of animals and plant species, and artistic issues related to the preservation of the planet Earth.
                    As you know, several smart contracts have been launched this way so far, and those that were originally raw ideas have finally turned into huge projects.
                    We hope that you will join this global alliance and that we will all share in a great way of saving this beautiful planet.</p>
            </div>
        </div>
    </section>
    ...
    <section class="bg padding" id="sect-about-us">
        <div class="uk-container">
            <div class="uk-width-2-3@m uk-text-center uk-margin-auto uk-margin-large-bottom">
                <hr>
                <h2>About us</h2>
                <p>By providing a dedicated CRM platform and panel for any type of business in all areas, we will help
                    strengthen and prosper your economy and your business in a safe, independent and dedicated
                    environment with what you need You are expanding worldwide and in the form of global network
                    marketing.
                    We allow people anywhere in the world to get to know your business and introduce it to others, so
                    they can make money and expand your business. By providing a completely independent and secure
                    platform and environment, we will develop your business and with your advice,
                    we will globalize your business and give you the capabilities to be able to introduce your business
                    in all the world and
                    countries without any restrictions and representatives. From all over the world for your business,
                    considering the economy
                    of that region and their culture and needs, you can promote and introduce business. Our consultants
                    will always and at all
                    times reach out to your representatives and develop your business and will provide them with good
                    solutions according to the economy of that region.
                    We strive to develop and expand your business by providing a complete platform and environment for
                    network marketing without any geographical,
                    cultural or economic restrictions.</p>
            </div>
            <div class="uk-child-width-1-2@s uk-child-width-1-4@m uk-grid-medium uk-grid" data-uk-grid=""
                ...
                <div class="uk-first-column">
                    <div class="uk-card sc-card-flat">
                        ...
                        <div class="uk-card-body">
                            <p>
                                Companies requesting an authorized representative to develop their business on our
                                platform through the CRM panel
                            </p>
                ...
                <div>
                    <div class="uk-card sc-card-flat" style="min-height: 309.469px;">
                        ...
                        <div class="uk-card-body">
                            <p>
                                “Becoming data-driven has become a general goal for many companies”, says Mike Rollings,
                ...
                <div>
                    <div class="uk-card sc-card-flat" style="min-height: 309.469px;">
                        ...
                        <div class="uk-card-body">
                            <p>
                                With attackers employing more complex obfuscation techniques, cyberattacks are becoming
                ...
                <div class="uk-width-2-5@m uk-first-column">
                    ...
                    <ul class="sc-list">
                        <li>
                            ...
                            <address>
                                5th Floor, Ossen International, Building A, No.925 Yunshui Yilu, Xi'an Hi-tech Zone,
                                Yanta Disctrit, Xi'an, Shaanxi Province, China, 710003
                            </address>
                        </li>
                        <li>
                            <div class="sc-list-icon">
                    ...
                    <form action="#">
                        <div class="sc-input-wrapper uk-margin">
                            <input class="uk-input" type="text" id="name" name="name"
                                   style="padding: 24px 12px 8px !important;">
