            ...
            <div class="border-bottom">
                <div class="row">
                    ...
                    <div class="col-md-4 pull-left text-left">
                        <a class="btn btn-primary pull-left" href="{{route('cp.bourse.create')}}" style="margin-right: 5px ">ثبت خبر جدید</a>
                    </div>
                </div>
                    ...
                    <table class="table table-hover table-striped  table-white">
                        ...
                        @foreach($bourse_newses as $blog  )
                            <tr  class="item-row">
                                ...
                                <td> <a class="btn btn-dark" target="_blank" href="{{route('bourse.show' ,['url'=>$blog->url])}}">پیش نمایش</a> </td>
                                <td>

                                    {!! edit_btn(route('cp.bourse.create' , ['id'=>$blog->id ])) !!}
                                    {!! delete_btn( $blog->id ,  route('cp.bourse.delete')) !!}
                                </td>
                            </tr>
                        @endforeach
